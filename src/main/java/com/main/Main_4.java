...
import com.hibernateDAO.AlbumEntity;
import com.hibernateDAO.HibernateSessionFactory;
...
public class Main_4 {
    ...
    public static final String SCRIPT_FILE = "resultScript.sql";
    ...
    private static SchemaExport getSchemaExport() {
        ...
        System.out.println("Выходной файл: " + outputFilePath);
    ...
    public static void main(String[] args) {
        ...
        albumEntity.setId(99999);
        albumEntity.setName("Best song ever");
        albumEntity.setGenre("VN");
        albumEntity.setIdSinger(11);
